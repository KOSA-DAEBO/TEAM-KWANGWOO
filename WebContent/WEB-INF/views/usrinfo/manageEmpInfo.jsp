...
<body>
	<div id="usrcontainer">
		<form class="manageForm" action="updateManageEmpInfo.do?empNo=${empDto.empNo}" method="post">
			<div class="usrInfo">
				...
				<div class="table3">
					...
					<div>기본급</div>
					<div><input type="number" id="ManageEmpSalary" name="ManageEmpSalary" value="${empDto.salary}"></div>
				</div>
				<div class="table2">
					...
					<div id="empDeptList">
						...
						<input type="radio" value="30" name="deptNo" ${empDto.deptNo == "30" ? "checked" : ""}/>마케팅
				...
				<div class="table2">
					...
					<div id="empPosList">
						...
						<input type="radio" value="40" name="posNo" ${empDto.posNo == "40" ? "checked" : ""}/>차장
						...
						<input type="radio" value="100" name="posNo" ${empDto.posNo == "100" ? "checked" : ""}/>인턴
