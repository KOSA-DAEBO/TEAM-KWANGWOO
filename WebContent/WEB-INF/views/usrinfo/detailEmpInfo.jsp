...
<body>
	<div id="usrcontainer" align="center">
		<table id="usrinfo">
			<tr>
				<td>이름</td>
				<td><input type="text" value="${empList.empdto.empName}" placeholder="${empList.empdto.empName}"></td>
			</tr>
			<tr>
				<td>사번</td>
			...
			<tr>
				<td>주소</td>
				<td><input type="text" value="${empList.empdto.empAddr}" placeholder="${empList.empdto.empAddr}"></td>
			</tr>
			<tr>
				<td>전화번호</td>
				<td><input type="text" value="${empList.empdto.empTel}" placeholder="${empList.empdto.empTel}"></td>
			</tr>
			<tr>
				<td>성별</td>
				<td><c:choose>
			...
			<tr>
				<td>이메일</td>
				<td><input type="text" value="${empList.empdto.empEmail}" placeholder="${empList.empdto.empEmail}"></td>
			</tr> 
			<tr>
				<td>생년월일</td>
