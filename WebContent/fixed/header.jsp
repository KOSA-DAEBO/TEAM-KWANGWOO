...
<body>
	<div class="header noindex">
		<div class="head" id="head">
			<div class="head_top">
				<h1>
					<a href="commuteEmpChk.do" title="메인으로 이동"><img
						src="./images/logo.png" alt="광우" class="logo" /></a>
				</h1>
				<div>
					<c:choose>
						<c:when test="${not empty sessionScope.login}">
							...
							<button class="iconText joinButton" id="myPageButton"
								onClick="location.href='empDetail.do'">마이페이지</button>
							<a class="iconText"> ${sessionScope.login.usrId}님
								안녕하세요&nbsp&nbsp</a>
						</c:when>
						<c:otherwise>
			...
			<div class="head_bottom">
				<c:if test="${not empty sessionScope.login}">
					<div class="head_bottom_in">
						<div class="head_menu">
							<ul>
								<li class=""><a href="empList.do" title="인사">인사</a></li>
