    ...
    <div class="header noindex">
      <div class="head" id="head">
         <div class="head_top">
            ...
            <div>
               <span class="material-symbols-outlined" OnClick="location.href='/TEAM-KWANGWOO/loginCustomer.do'">login</span>
               <span class="material-symbols-outlined">logout</span>
               <span class="material-symbols-outlined" OnClick="location.href='/TEAM-KWANGWOO/joinCustomer.do'">person_add</span>
            </div>
         </div>
         <!-- //head_top -->
